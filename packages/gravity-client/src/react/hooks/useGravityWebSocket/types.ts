...
export interface UseGravityWebSocketReturn {
  ...
  /** Current node execution event for GravityCanvas debug visualization */
  nodeExecutionEvent: any | null;
...
export interface MessageHandlerContext {
  ...
  setNodeExecutionEvent?: (event: any) => void; // For GravityCanvas debug visualization
