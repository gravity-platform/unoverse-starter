/**
 * StatementReport Node Definition
 * Auto-generated from Storybook component
 */

import { NodeInputType, type EnhancedNodeDefinition } from "@gravity-platform/plugin-base";
import StatementReportExecutor from "./executor";
import { loadDefaultTemplate } from "../service/templates";

export const NODE_TYPE = "StatementReport";
...
export function createNodeDefinition(): EnhancedNodeDefinition {
  return {
    ...
    description: "StatementReport print document from design system",
    category: "Print",
    color: "#8b5cf6",
...
export const StatementReportNode = {
  definition,
