/**
 * PDFViewer Node Executor
 * Auto-generated from Storybook component
 */

import { PromiseNode, type ValidationResult, type NodeExecutionContext } from "@gravity-platform/plugin-base";
import { PDFViewerConfig, PDFViewerOutput } from "../util/types";
import { loadDefaultTemplate } from "../service/templates";
import { publishComponent } from "../service/publishComponent";

export default class PDFViewerExecutor extends PromiseNode {
  constructor() {
    super("PDFViewer");
  }

  protected async validateConfig(config: PDFViewerConfig): Promise<ValidationResult> {
    return { success: true };
  }
  ...
  protected async executeNode(
    ...
    this.logger.info(`✅ [PDFViewer] ComponentSpec generated for node: ${context.nodeId}`);
